defmodule Bash.SessionEnvTest do
  ...
  describe "system environment is not inherited by default" do
    ...
    test "system env vars not in bash defaults are absent", %{session: session} do
      ...
      bash_default_keys =
        ~w(BASH BASH_VERSION BASH_VERSINFO PWD OLDPWD HOME USER LOGNAME PATH HOSTNAME
           ...
           GROUPS OPTERR OPTIND COLUMNS LINES COMP_WORDBREAKS CDPATH HISTFILE
           HISTIGNORE SHELLOPTS GLOBIGNORE IGNOREEOF MAILCHECK TIMEFORMAT)
